...
<html<?php echo ' lang="'.$conf['current_language'].'"'; ?>>
	<head>
		...
		?>
				...
				<script async src="https://www.googletagmanager.com/gtag/js?id=<?php echo $conf['google_analytics'] ?>"></script>
				<script>
				  window.dataLayer = window.dataLayer || [];
				  function gtag(){dataLayer.push(arguments);}
				  gtag('js', new Date());

				  gtag('config', '<?php echo $conf['google_analytics'] ?>');
				</script>
		...
		<meta name="twitter:site" content="@altstalkersite">
		<meta name="twitter:domain" content="AltStalker.com">
		<meta name="twitter:card" content="summary_large_image">
		<meta property="og:type" content="website">
		<meta property="og:title" content="Alt Stalker">
		<meta name="twitter:title" content="Alt Stalker">
		<meta property="og:description" content="Track all your crypto needs with useful tools">
		<meta name="twitter:description" content="Track all your crypto needs with useful tools">
		<meta property="og:image" content="https://i.imgur.com/dVbPgKh.png">
		<meta property="og:image:height" content="125">
		<meta property="og:image:width" content="125">
		<meta name="twitter:image:src" content="https://i.imgur.com/dVbPgKh.png">
...
<?php
					...
					if(isset($conf['github']) && $conf['github'] != '') {
?>
					<li><a href="<?php echo $conf['github']; ?>" target="_blank"><i rel="tooltip" title="GitHub" class="fa fa-github fa-fw fa-3x"></i></a></li>
<?php
					}
		...
		<div class="modal fade" id="info" tabindex="-1">
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-body">
						<?php
								if($conf['donation_activated']) {
						?>
									<div class="Donations">
										<ul>
						<?php
											if(isset($conf['donation_title']) && $conf['donation_title'] != '') {
						?>
											<?php echo $conf['donation_title']; ?>
						<?php
											}
											if(isset($conf['BTC']) && $conf['BTC'] != '') {
						?>
											<li>BTC: <?php echo $conf['BTC']; ?></li>
						<?php
											}
											if(isset($conf['ETH']) && $conf['ETH'] != '') {
						?>
											<li>ETH: <?php echo $conf['ETH']; ?></li>
						<?php
											}
											if(isset($conf['LTC']) && $conf['LTC'] != '') {
						?>
											<li>LTC: <?php echo $conf['LTC']; ?></li>
						<?php
											}
											if(isset($conf['LBC']) && $conf['LBC'] != '') {
						?>
											<li>LBC: <?php echo $conf['LBC']; ?></li>
						<?php
											}
						?>
										</ul>
...
<?php
		...
		if ($conf['map_activated']) {
?>
		<script src="https://maps.googleapis.com/maps/api/js?key=<?php echo $conf['map_api_key']?>&v=3.exp&amp;sensor=false"></script>
<?php
		}
?>
