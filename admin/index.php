...
<html>
	...
	if(isset($_SESSION['logged'])) { ?>
		<div class="logout">
			<p><?php echo $lang['welcome_admin']; ?> | <a href='index.php'><?php echo $lang['subscribers']; ?></a> | <a href='index.php?admin=logout'><?php echo $lang['logout']; ?></a></p>
		</div><?php } ?>
		<!-- Main Content -->
		<div class="admin">
			<?php
		...
		<div class='footer'>
			<a href='https://github.com/MSFTserver'>Coming Soon Page</a> by <a href="http://soon.MSFT.online">MSFTserver</a>
		</div>
		<!-- /Main Content -->
		<!-- JavaScript-->
